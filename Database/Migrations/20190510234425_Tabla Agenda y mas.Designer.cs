...
namespace Database.Migrations
{
    ...
    [Migration("20190510234425_Tabla Agenda y mas")]
    partial class TablaAgendaymas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Data.Entities.Agendas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Database.Models.Calificaciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Database.Models.Docentes", b =>
                {
                    b.HasBaseType("Database.Models.Usuarios");
                    ...
                    b.HasDiscriminator().HasValue("Docentes");
                });

            modelBuilder.Entity("Database.Data.Entities.Agendas", b =>
                {
                    b.HasOne("Database.Models.Usuarios", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("Database.Models.Asistencias", b =>
                {
                    ...
                    b.HasOne("Database.Models.Cursos", "Curso")
                        .WithMany()
            ...
            modelBuilder.Entity("Database.Models.Cursos", b =>
                {
                    b.HasOne("Database.Models.Docentes", "Docentes")
                        .WithMany("Cursos")
            ...
            modelBuilder.Entity("Database.Models.CursosAlumnos", b =>
                {
                    ...
                    b.HasOne("Database.Models.Cursos", "CursoId")
                        .WithMany()
